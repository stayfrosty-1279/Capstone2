...
<body style=" overflow-x: hidden !important;">
 ...
 <div class="file-sharing-container">
        <div class="header-container">
            <h2 class="header-title">MY SHARED FILES</h2>
        ...
        <table id="zctb" class="files-table display table-striped table-bordered table-hover" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                $checkresident2 = mysqli_query($DB, "SELECT * FROM files WHERE f_user_id = '$myuserid' AND f_org_id = '$org_id' ORDER BY f_date DESC");
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="delete-btn" data-toggle="modal" data-target="#deleteUsers<?php echo $package_id; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="modal-footer justify-content-end">
                                                    <input type="hidden" name="user_ID_Delete" value="<?php echo $package_id; ?>">
